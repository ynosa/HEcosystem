var optional = require('./lib/optional')
  , http = require('github:jspm/nodelibs@0.0.2/http')
  , https = optional('https')
  , tls = optional('tls')
  , url = require('github:jspm/nodelibs@0.0.2/url')
  , util = require('github:jspm/nodelibs@0.0.2/util')
  , stream = require('github:jspm/nodelibs@0.0.2/stream')
  , qs = require('qs')
  , querystring = require('github:jspm/nodelibs@0.0.2/querystring')
