...
//    };
    ...
    var getData = function(filter) {
        ...
        if(filter)
        {
            ...
            return {
                nodeGroups: _(jsonData.groups).filter(function (group){ return nodeGroupsObj[group.id];}),
                ...
                linkGroups: _(jsonData.linkGroups).filter(function (linkGroup) {return linkGroupObj[linkGroup.type];})
            }
        }
        else
        {
